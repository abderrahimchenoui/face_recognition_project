# inference onnx using resnet50-caffe2-v1-7 model
...
session = rt.InferenceSession('resnet50-caffe2-v1-7.onnx')
...
out = session.run(None, {input_name: im})[0]
...
# inference onnx using res resnet50-v1-7.onnx
...
# Inference using onnx
session = rt.InferenceSession('resnet50-v2-7.onnx')
#session.set_providers(['CUDAExecutionProvider'])
