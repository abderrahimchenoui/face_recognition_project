...
import sys
import cv2
from df_config import define_img_size
...
parser.add_argument('--test_device', default="cpu", type=str,
                   help='cuda:0 or cpu')
parser.add_argument('--video_path', default="C:\\Users\\User\\Desktop\\MINI PROJET\\video.MP4", type=str,
                    help='path of video')
...
if net_type == 'slim':
    ...
    model_path = "version-RFB-320.pth"
